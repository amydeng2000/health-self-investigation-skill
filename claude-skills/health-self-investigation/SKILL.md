...
- Claude Code: inspect user-provided files when relevant and create concrete artifacts such as CSV trackers or summaries.
...
- In Claude Code, create CSV/spreadsheet templates when useful. In chat-only contexts, provide a copy-pasteable table or CSV block.
...
Use Analysis when the user brings data. In Claude Code, inspect relevant files directly. Summarize what you used and keep methods transparent.
